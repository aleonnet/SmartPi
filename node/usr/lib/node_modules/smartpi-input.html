...
<script type="text/x-red" data-template-name="smartpi-input">
    <div class="form-row">
		...
		<option value="i4">Current neutral</option>
		<option value="v1">Voltage phase 1</option>
        <option value="v2">Voltage phase 2</option>
        <option value="v3">Voltage phase 3</option>
		<option value="pf1">Power factor 1</option>
        <option value="pf2">Power factor 2</option>
        <option value="pf3">Power factor 3</option>
